...
// for the reverse Follow direction. Includes the search bar shell (see
// SearchBarSkeleton) since FollowingListSection renders one via
// UserListWithSearch — without it here, that bar would pop in only
