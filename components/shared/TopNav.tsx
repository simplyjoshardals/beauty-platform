...
//   return (
//     <nav
//       className="fixed top-0 left-0 right-0 z-50 grid grid-cols-[1fr_auto_1fr] items-center h-14 pt-[env(safe-area-inset-top)] px-4 border-b border-foreground/10 bg-background"
//       aria-label="Top"
//     >
...
//         width={100}
//         height={50}
//         className="justify-self-center h-auto w-auto"
//         loading="eager"
//       />
